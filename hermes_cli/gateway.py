...
def _launchd_bootstrap(plist_path: Path, attempts: int = 3) -> None:
    """Bootstrap the launchd plist, retrying transient label teardown races."""
    import time
...
def launchd_stop():
    ...
    # immediately restarts it because KeepAlive is true.
